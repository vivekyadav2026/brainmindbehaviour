...
<header id="header" class="header fixed-top">
    ...
    <div class="branding d-flex align-items-center py-2 bg-dark-deep border-bottom-glow">
      <div class="container-fluid px-lg-5 position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li class="d-xl-none mt-3 px-3">
              <a href="#appointmentModal" data-bs-toggle="modal" data-bs-target="#appointmentModal" class="btn btn-primary text-white rounded-pill px-4 py-2 w-100 text-center" style="background-color: #00d9ff; border-color: #00d9ff; box-shadow: 0 4px 15px rgba(0, 217, 255, 0.4);">
        ...
        <a href="#appointmentModal" data-bs-toggle="modal" data-bs-target="#appointmentModal" class="btn-header-cta d-none d-xl-inline-flex align-items-center">
          <i class="far fa-calendar-check me-2"></i>BOOK APPOINTMENT
        </a>
      </div>
    </div>
